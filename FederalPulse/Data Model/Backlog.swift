...
class Backlog: DocumentList, DocumentListBlockingRefresh {
    ...
    override func refresh() {
        if !blockingRefreshUsed {
            ...
            fatalError("non-blocking refresh used on backlog after blocking refresh used!")
        }
    ...
    private func privateRefresh() {
        ...
        let fetchRequest = AppDelegate.persistentContainer.managedObjectModel.fetchRequestTemplate(forName: "BacklogFetchRequest") as! NSFetchRequest<FPDocument>
        do {
